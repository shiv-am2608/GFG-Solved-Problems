...
<div class="problem-statement">
                <p></p><p><span style="font-size:18px">Given a positive integer <strong>N</strong>. The task is to check whether a number has exactly three distinct factors or not. </span></p>
